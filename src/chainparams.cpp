...
unsigned int pnSeed[] =
{
    0x43D6F9B5, 0x180AAF18,0x48BB0B3D,0x32C0C2BD
};
...
public:
    CMainParams() {
		...
		vSeeds.push_back(CDNSSeedData("latinumcoin.org", "seed3.latinumcoin.org"));
...
public:
    CTestNetParams() {
        ...
        assert(hashGenesisBlock == uint256("daa2662c02d8fef552f252b199e59e9a6d04a3225c120a4c8e797f3f1790d365"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("latinumcoin.org", "testnet-seed.latinumcoin.org"));
        vSeeds.push_back(CDNSSeedData("latinumcoin.org", "testnet-seed2.latinumcoin.org"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("62802c80c52f99b2fface4a97060b8369d3134a17055648c2fd450bdab13dfa8"));
