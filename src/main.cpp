...
#if defined(NDEBUG)
# error "Latinumcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Latinumcoin Signed Message:\n";
...
string GetWarnings(string strFor)
{
    ...
    if (!CLIENT_VERSION_IS_RELEASE)
        strStatusBar = _("This is a pre-release test build - use at your own risk - Once we have a final build you will not see this message.");
